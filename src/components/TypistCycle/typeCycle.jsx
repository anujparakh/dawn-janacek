...
export default class TypistCycle extends React.Component {
  ...
  render() {
    ...
    var toUse = this.state.currentLine
    if(this.state.currentLine >= this.props.content.length)
    {
        toUse = 0
    }
    const lineToPrint = this.props.content[toUse];
    ...
    return (
      ...
      >
        ...
        <Typist.Backspace count={lineToPrint.length} delay={2000} ></Typist.Backspace>
    </Typist>
    );
  }
}
